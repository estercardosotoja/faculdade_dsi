...
public class Perceptron {
    public static void main(String args[]) {
        ...
        double eta = 1;
        /*
        * Declarado dois vetores que irá receber os dados normalizados das rendas e das dividas.
        * */
        double norma1[] = new double[14];
        double norma2[] = new double[14];
        /*
        * Declarado variaveis que serão usadas no calculo da normalização
        * */
        double xminren = 100000, xmaxren = 0, xmindiv = 100000, xmaxdiv = 0;

        /*
        * Para realizar a normalização usarei a regra:
        * C' = (valor_entrada - valor_minimo) / (valor_maximo - valor_minimo)
        *
        ...
        *  */
        ...
        for (i = 0; i < x1.length; i++) {
            norma1[i] = ((x1[i] - xminren) / (xmaxren - xminren));
        }

        //Normalizacao da Divida
        for (i = 0; i < x2.length; i++) {
            norma2[i] = ((x2[i] - xmindiv) / (xmaxdiv - xmindiv));
        }
        ...
        System.out.println("\n--- GENERALIZACAO");
        System.out.println("\n Utilizado calculo  C' = ((valor_entrada - valor_minimo)  / (valor_maximo - valor_minimo)");
        ...
        while (true) {
            ...
            //Normalizacao
            esca1 = ((entrada1 - xminren) / (xmaxren - xminren));
            esca2 = ((entrada2 - xmindiv) / (xmaxdiv - xmindiv));
